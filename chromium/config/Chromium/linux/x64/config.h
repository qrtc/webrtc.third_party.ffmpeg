...
#define FFMPEG_CONFIGURATION "--disable-everything --disable-all --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-static --enable-avcodec --enable-avformat --enable-avutil --enable-swscale --enable-swresample --enable-libx264 --enable-encoder=libx264 --enable-decoder=h264 --enable-libfdk-aac --enable-encoder=libfdk_aac --enable-gpl --enable-nvenc --enable-cuda --enable-nonfree --enable-fft --enable-rdft --enable-static --enable-libopus --disable-bzlib --disable-error-resilience --disable-iconv --disable-lzo --disable-schannel --disable-sdl --disable-symver --disable-xlib --disable-securetransport --disable-d3d11va --disable-dxva2 --disable-vaapi --disable-vda --disable-vdpau --disable-videotoolbox --disable-cuvid --enable-decoder='vorbis,libopus,flac,aac,png,gif,mjpeg' --enable-decoder='pcm_u8,pcm_s16le,pcm_s24le,pcm_s32le,pcm_f32le' --enable-decoder='pcm_s16be,pcm_s24be,pcm_mulaw,pcm_alaw' --enable-demuxer='ogg,matroska,wav,flac,flv,image_png_pipe' --enable-parser='opus,vorbis,flac' --enable-protocol='file,pipe,http,https' --extra-cflags=-I/home/qboxserver/xieran/webrtc/src/third_party/opus/src/include --optflags='\"-O2\"' --enable-decoder='theora,vp8' --enable-parser='vp3,vp8' --enable-lto --enable-pic"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 5.4.1 (Ubuntu 5.4.1-2ubuntu1~14.04) 20160904"
